/**
 *
 * src/themes/ThemeElementName.ts
 *
 * Список всех цветовых ролей темы для VS Code.
 *
 * Этот файл определяет полный набор цветовых токенов, используемых в теме Vela Spectrum,
 * включая все поддерживаемые категории: редактор, панели, Git, отладка, терминал, чат и другие.
 *
 * Каждая запись содержит:
 * - `name`: имя цвета в формате VS Code (например, `editor.background`)
 * - `color`: функция, извлекающая значение из сгенерированной палитры (например, `colors.accent.fg`)
 * - `Alpha`: уровень прозрачности (от 0 до 10, где 10 = 100%)
 * - `description`: пояснение назначения цвета для документации
 *
 * Используется в ThemeGenerator для генерации финальных `themes/*.json` файлов.
 *
 * Поддерживает семантическое связывание с палитрой из ThemeColors, обеспечивая:
 * - Единую цветовую систему
 * - Доступность (через режимы: highContrast, colorblind и др.)
 * - Гибкость при стилизации
 *
 * @constant ThemeElementName
 * @author telianedward
 * @see https://code.visualstudio.com/api/references/theme-color  – Официальная документация по цветам тем VS Code
 * @see https://github.com/telianedward/VelaSpectrum             – Репозиторий Vela Spectrum
 * @license MIT
 *
 */
 ...
 */
  ...
  {
    "name": "focusBorder",
    color: ( colors: any ) => colors.accent.emphasis,
    "Alpha": 10,
  ...
  },
  {
    ...
    color: ( colors: any ) => colors.danger.fg,
    "Alpha": 10,
 ...
 */
  ...
  */
  ...
  },
  {
    ...
    color: ( colors: any ) => colors.danger.muted,
    "Alpha": 5,
  ...
  },
  {
    ...
    color: ( colors: any ) => colors.severe.fg,
    "Alpha": 2,
   ...
   */
  {
    ...
    color: ( colors: any ) => colors.accent.muted,
    "Alpha": 7,
  ...
  },
  {
    ...
    color: ( colors: any ) => colors.attention.fg,
    "Alpha": 10,
  ...
  },
  {
    ...
    color: ( colors: any ) => colors.severe.muted,
    "Alpha": 10,
  ...
  },
  {
    ...
    color: ( colors: any ) => colors.attention.emphasis,
    "Alpha": 10,
  ...
  ///////////////////////////.      Основной момент символа видна при навигации по символу по команде, такой как определение.     //////////
  {
    ...
    color: ( colors: any ) => colors.done.emphasis,
    "Alpha": 5,
  ...
  //},
  {
    ...
    color: ( colors: any ) => colors.sponsors.fg,
    "Alpha": 2,
  ...
  },
  {
    ...
    color: ( colors: any ) => colors.closed.fg,
    "Alpha": 2,
  ...
  },
  {
    ...
    color: ( colors: any ) => colors.sponsors.muted,
    "Alpha": 10,
...
{
  "name": "editorLightBulbBorder",
  color: (colors: any) => colors.accent.fg,
  "Alpha": 10,
  "description": "цвет границы всех лампочек."
},
{
  "name": "editorLightBulbAiBorder",
  color: (colors: any) => colors.sponsors.fg,
  "Alpha": 10,
  "description": "цвет границы лампочки AI-действий."
},
{
  "name": "editorLightBulbAutoFixBorder",
  color: (colors: any) => colors.attention.fg,
  "Alpha": 10,
  "description": "цвет границы лампочки автозамены."
},
 ...
 *
 * ВАЖНО: Для подсветки вставок и удалений используйте ЛИБО фон, ЛИБО границу — не оба сразу.
 * Мы используем фон, но НЕ используем границу, чтобы не перегружать интерфейс.
 *
 * @see https://code.visualstudio.com/api/references/theme-color#diff-editor-colors
 */

// === Границы и общие элементы ===
{
...
// === Вставленный код (зелёный) ===
{
  "name": "diffEditor.insertedLineBackground",
  color: (colors: any) => colors.success.muted, // Было: success.emphasis → стало мягче
  "Alpha": 3, // Было: 5 → стало тише
  "description": "Фон строк, которые были вставлены. Приглушённый, чтобы не бросаться в глаза."
},
{
  "name": "diffEditor.insertedTextBackground",
  color: (colors: any) => colors.success.muted,
  "Alpha": 3,
  "description": "Фон текста, который был вставлен. Совпадает с фоном строки."
},
// ❌ Граница отключена — не используем, чтобы не дублировать
// "diffEditor.insertedTextBorder" — не задан

// === Удалённый код (красный) ===
{
  "name": "diffEditor.removedLineBackground",
  color: (colors: any) => colors.danger.muted,
  "Alpha": 3, // Было: 5 → стало мягче
  "description": "Фон строк, которые были удалены. Спокойный, не агрессивный."
},
{
  "name": "diffEditor.removedTextBackground",
  color: (colors: any) => colors.danger.muted,
  "Alpha": 3,
  "description": "Фон текста, который был удалён. Совпадает с фоном строки."
},
// ❌ Граница отключена — не используем, чтобы не дублировать
// "diffEditor.removedTextBorder" — не задан

// === Гуттер (поле слева с номерами строк) ===
{
  "name": "diffEditorGutter.insertedLineBackground",
  color: (colors: any) => colors.success.muted,
  "Alpha": 4,
  "description": "Фон в гуттере для вставленных строк. Мягкий, не яркий."
},
{
  "name": "diffEditorGutter.removedLineBackground",
  color: (colors: any) => colors.danger.muted,
  "Alpha": 4,
  "description": "Фон в гуттере для удалённых строк."
},

// === Линейка обзора (мини-карта) ===
{
...
// === Неизменённые блоки (например, при свёртке) ===
{
...
// === Перемещённый текст (редко используется) ===
{
...
},
{
  ...
  color: (colors: any) => colors.attention.emphasis,
  "Alpha": 10,
  "description": "Цвет активной границы для перемещённого текста."
},

// === Многофайловое сравнение ===
{
...
},
{
  ...
  },
  {
    ...
    color: ( colors: any ) => colors.ansi.black,
    "Alpha": 9,
  ...
  {
    "name": "terminal.suggestWidgetForeground",
    color: ( colors: any ) => colors.fg.default,
    "Alpha": 10,
    "description": "Цвет текста в виджете подсказок терминала."
  },
  {
    "name": "terminal.suggestWidgetBackground",
    color: ( colors: any ) => colors.canvas.inset,
    "Alpha": 10,
    "description": "Фон виджета подсказок терминала."
  },
  {
    "name": "terminal.suggestWidgetBorder",
    color: ( colors: any ) => colors.border.muted,
    "Alpha": 10,
    "description": "Граница виджета подсказок терминала."
  },
  {
    "name": "terminalSymbolIcon.flagForeground",
    color: ( colors: any ) => colors.accent.fg,
    "Alpha": 10,
    "description": "Цвет иконки флага в подсказках терминала."
  },
  ...
  },
  {
    ...
    color: ( colors: any ) => colors.severe.emphasis,
    "Alpha": 10,
  ...
  },
  {
    ...
    color: ( colors: any ) => colors.open.fg,
    "Alpha": 10,
  ...
  },
  {
    ...
    color: ( colors: any ) => colors.open.emphasis,
    "Alpha": 10,
  ...
  },
  {
    ...
    color: ( colors: any ) => colors.danger.emphasis,
    "Alpha": 10,
  ...
  },
  {
    ...
    color: ( colors: any ) => colors.fg.subtle,
    "Alpha": 10,
  ...
  },
  {
    ...
    // 🛠 ESLint
  {
    name: "eslint.rule.error",
    color: (colors: any) => colors.danger.muted,
    Alpha: 10,
    description: "Цвет подчёркивания ошибок ESLint."
  },
  {
    name: "eslint.rule.warning",
    color: (colors: any) => colors.severe.muted,
    Alpha: 10,
    description: "Цвет подчёркивания предупреждений ESLint."
  },
  {
    name: "eslint.rule.info",
    color: (colors: any) => colors.accent.fg,
    Alpha: 7,
    description: "Цвет подчёркивания информационных сообщений ESLint."
  },

  // 🐍 Pylint / Python
  {
    name: "python.analysis.errorOutline",
    color: (colors: any) => colors.danger.muted,
    Alpha: 10,
    description: "Граница вокруг ошибок Pylint."
  },
  {
    name: "python.analysis.warningOutline",
    color: (colors: any) => colors.severe.muted,
    Alpha: 10,
    description: "Граница вокруг предупреждений Pylint."
  },
  {
    name: "python.analysis.infoOutline",
    color: (colors: any) => colors.accent.fg,
    Alpha: 7,
    description: "Граница вокруг информационных сообщений Python."
  },
  {
    name: "python.analysis.suggestionOutline",
    color: (colors: any) => colors.fg.muted,
    Alpha: 5,
    description: "Граница вокруг предложений Python (например, неиспользуемые импорты)."
  },

  // 🦀 Clippy / Rust
  {
    name: "rust-analyzer.diagnosticError",
    color: (colors: any) => colors.danger.muted,
    Alpha: 10,
    description: "Цвет подчёркивания ошибок Clippy / rust-analyzer."
  },
  {
    name: "rust-analyzer.diagnosticWarning",
    color: (colors: any) => colors.severe.muted,
    Alpha: 10,
    description: "Цвет подчёркивания предупреждений Clippy / rust-analyzer."
  },
  {
    name: "rust-analyzer.diagnosticInfo",
    color: (colors: any) => colors.accent.fg,
    Alpha: 7,
    description: "Цвет подчёркивания информационных сообщений rust-analyzer."
  },
  {
    name: "rust-analyzer.unnecessary",
    color: (colors: any) => colors.fg.muted,
    Alpha: 5,
    description: "Цвет для ненужного кода (например, неиспользуемые переменные)."
  },
  {
    name: "rust-analyzer.unreachable",
    color: (colors: any) => colors.danger.muted,
    Alpha: 7,
    description: "Цвет для недостижимого кода."
  },

  // 🧩 Общие диагностики (универсальные)
  {
    name: "editor.snippetTabstopHighlightBackground",
    color: (colors: any) => colors.accent.fg,
    Alpha: 2,
    description: "Фон подсветки табстопов сниппетов."
  },
  {
    name: "editor.snippetTabstopHighlightBorder",
    color: (colors: any) => colors.accent.fg,
    Alpha: 5,
    description: "Граница подсветки табстопов сниппетов."
  },
  {
    name: "editor.snippetFinalTabstopHighlightBackground",
    color: (colors: any) => colors.success.emphasis,
    Alpha: 2,
    description: "Фон последнего табстопа сниппета."
  },
  {
    name: "editor.snippetFinalTabstopHighlightBorder",
    color: (colors: any) => colors.success.emphasis,
    Alpha: 5,
    description: "Граница последнего табстопа сниппета."
  },
  {
  name: "golang.vet.error",
  color: (colors: any) => colors.danger.muted,
  Alpha: 10,
  description: "Цвет подчёркивания ошибок от go vet."
},
{
  name: "golang.vet.warning",
  color: (colors: any) => colors.severe.muted,
  Alpha: 10,
  description: "Цвет подчёркивания предупреждений от go vet."
},

// 🐚 SHELLCHECK
{
  name: "shellcheck.error",
  color: (colors: any) => colors.danger.muted,
  Alpha: 10,
  description: "Цвет подчёркивания ошибок ShellCheck."
},
{
  name: "shellcheck.warning",
  color: (colors: any) => colors.severe.muted,
  Alpha: 10,
  description: "Цвет подчёркивания предупреждений ShellCheck."
},
{
  name: "shellcheck.info",
  color: (colors: any) => colors.accent.fg,
  Alpha: 7,
  description: "Цвет подчёркивания информационных сообщений ShellCheck."
},
...
// 🎨 STYLELINT
{
  ...
  color: (colors: any) => colors.danger.muted,
  Alpha: 10,
  description: "Цвет подчёркивания ошибок Stylelint."
},
{
  name: "stylelint.warning",
  color: (colors: any) => colors.severe.muted,
  Alpha: 10,
  description: "Цвет подчёркивания предупреждений Stylelint."
},
{
  name: "stylelint.info",
  color: (colors: any) => colors.accent.fg,
  Alpha: 7,
  description: "Цвет подчёркивания информационных сообщений Stylelint."
},
];
